 ...
 * @param diskmap a pointer to the diskmap for the program
 * @param dst pointer to the frame to be filled with the data read from the disk
 * copied. This should be a pointer to the start of relevant frame in your
 * mem[] array.
 */
void diskmap_read(vpn_t vpn, uint64_t* diskmap, void* dst);
